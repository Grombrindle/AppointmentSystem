...
import com.AppointmentSystem.AppointmentSystem.dto.Requests.AuthRequest;
import com.AppointmentSystem.AppointmentSystem.dto.Requests.CustomerRegistrationRequest;
import com.AppointmentSystem.AppointmentSystem.dto.Requests.StaffRegistrationRequest;
import com.AppointmentSystem.AppointmentSystem.dto.Responses.ApiResponse;
import com.AppointmentSystem.AppointmentSystem.dto.Responses.AuthResponse;
import com.AppointmentSystem.AppointmentSystem.dto.Responses.CustomerResponse;
...
import com.AppointmentSystem.AppointmentSystem.security.JwtUtil;
...
public class AuthController extends BaseController {
    ...
    // @PostMapping("/login")
    // public ResponseEntity<ApiResponse<AuthResponse>> login(@RequestBody
    ...
    // .body(new ApiResponse<>(false, null, 401, "Invalid email or password",
    // "UNAUTHORIZED"));
    // } catch (Exception e) {
    // return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
    // .body(new ApiResponse<>(false, null, 500, "Login failed: " + e.getMessage(),
    // "INTERNAL_ERROR"));
    // }
    // }

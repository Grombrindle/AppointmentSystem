package com.AppointmentSystem.AppointmentSystem.AOP;
...
public class ClearConsoleLogger {
    ...
    @Around("execution(* com.AppointmentSystem.AppointmentSystem.controller..*(..)) || " +
            "execution(* com.AppointmentSystem.AppointmentSystem.service..*(..)) || " +
            "execution(* com.AppointmentSystem.AppointmentSystem.repository..*(..))")

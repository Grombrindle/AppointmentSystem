package com.AppointmentSystem.AppointmentSystem.security;

import com.AppointmentSystem.AppointmentSystem.security.JwtAuthenticationFilter;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/ws-email/**", "/ws/**").permitAll() // Add WebSocket
                                                                                                       // endpoint

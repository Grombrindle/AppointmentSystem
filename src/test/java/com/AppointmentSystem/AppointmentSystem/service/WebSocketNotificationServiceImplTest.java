...
import com.AppointmentSystem.AppointmentSystem.service.impl.WebSocketNotificationServiceImpl;
...
public class WebSocketNotificationServiceImplTest {
    ...
    void notifyAppointmentStatusChange_sendsBothPrivateAndGlobal() {
        ...
        // verify(template,
        // atLeastOnce()).convertAndSend(eq("/topic/global-notifications"), any());
    }
}

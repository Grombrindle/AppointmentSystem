...
import com.AppointmentSystem.AppointmentSystem.service.impl.UserServiceImpl;
...
public class UserControllerValidationTest {
    ...
    @MockitoBean
    private com.AppointmentSystem.AppointmentSystem.security.JwtUtil jwtUtil;

    @MockitoBean
    private com.AppointmentSystem.AppointmentSystem.security.CustomUserDetailsService customUserDetailsService;
